  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <section aria-labelledby="collecting-and-using-your-personal-data">
          <h2
          ...
          <h4 className={styles.h4}>Personal Data</h4>
          <p className={styles.p}>
          ...
          <ul className={styles.ul}>
            <li className={styles.li}>Usage Data</li>
          </ul>
          <h4 className={styles.h4}>Usage Data</h4>
          <p className={styles.p}>
          ...
          <h4 className={styles.h4}>Tracking Technologies and Cookies</h4>
          <p className={styles.p}>
          ...
          <h3 className={styles.h3}>Use of Your Personal Data</h3>
          <p className={styles.p}>
          ...
          <h3 className={styles.h3}>Transfer of Your Personal Data</h3>
          <p className={styles.p}>
          ...
          <h3 className={styles.h3}>Delete Your Personal Data</h3>
          <p className={styles.p}>
          ...
          <h3 className={styles.h3}>Disclosure of Your Personal Data</h3>
          <h4 className={styles.h4}>Business Transactions</h4>
          <p className={styles.p}>
          ...
          <h4 className={styles.h4}>Law enforcement</h4>
          <p className={styles.p}>
          ...
          <h4 className={styles.h4}>Other legal requirements</h4>
          <p className={styles.p}>
            The Company may disclose Your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className={styles.ul}>
            <li className={styles.li}>Comply with a legal obligation</li>
            <li className={styles.li}>
            ...
            <li className={styles.li}>Protect against legal liability</li>
          </ul>
          <h3 className={styles.h3}>Security of Your Personal Data</h3>
          <p className={styles.p}>
        ...
        <section aria-labelledby="changes-to-this-privacy-policy">
          <h2 id="changes-to-this-privacy-policy" className={styles.h2}>
