...
export function generatePageInfo({
  ...
  const description = `Compare ${symbolOne} and ${symbolTwo} valuation, dividends, financial strength & more. Get our detailed side-by-side stock analysis to inform your view.`;
