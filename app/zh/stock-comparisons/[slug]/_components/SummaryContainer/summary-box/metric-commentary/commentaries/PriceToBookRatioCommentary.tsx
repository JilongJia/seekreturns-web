...
export function PriceToBookRatioCommentary({
  ...
  if (metricValue > max) {
    return (
      <P>
        {stockSymbol} 的市净率为 {formattedMetricValue}，极高，远超{" "}
        {industryName}{" "}
        行业的普遍估值范围。这表明市场对其估值主要基于未来的高增长预期或品牌等无形资产，而非其当前的净资产价值，这可能伴随着较高的估值风险。
      </P>
    );
  } else if (metricValue < min) {
    return (
      <P>
        {stockSymbol} 的市净率为 {formattedMetricValue}，低于 {industryName}{" "}
    ...
    return (
      <P>
        {stockSymbol} 的市净率为 {formattedMetricValue}，处于 {industryName}{" "}
    ...
    return (
      <P>
        {stockSymbol} 的市净率为 {formattedMetricValue}，位于 {industryName}{" "}
    ...
    return (
      <P>
        {stockSymbol} 的市净率为 {formattedMetricValue}，处于 {industryName}{" "}
        行业的中等区间。这表明其市值相对于账面价值的水平符合行业基准，估值既不显昂贵也不显便宜。
      </P>
    );
  }
}
