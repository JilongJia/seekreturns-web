...
import styles from "./ProRataCalculator.module.css";

type ProRataCalculatorProps = { className?: string };

export function ProRataCalculator({ className }: ProRataCalculatorProps) {
