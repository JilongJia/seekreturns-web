...
import styles from "./FVIFCalculator.module.css";

type FVIFCalculatorProps = { className?: string };

export function FVIFCalculator({ className }: FVIFCalculatorProps) {
  ...
  if (errorMessages.length === 0) {
    ...
    fvif = Math.pow(1 + interestRateDecimalValue, numberOfPeriodsValue).toFixed(
      4,
    );
  }
  ...
  return (
    <Section className={className}>
      <ScreenReaderH2>FVIF Calculator</ScreenReaderH2>
      <Form>
        ...
        {fvif && (
          <OutputCard>
            <OutputCard.Label htmlFor="fvif-output">
            ...
            <OutputCard.P>
              ...
              {numberOfPeriodsValue} years, the future value of $1 is ${fvif}.
            </OutputCard.P>
          </OutputCard>
        )}
